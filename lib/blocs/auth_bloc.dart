...
import 'package:store/fire_base/fire_base_auth.dart';
...
class AuthBloc {
  ...
  bool isValid(String name, String email, String pass, String phone) {
    if (name == null || name.length == 0) {
      _nameController.sink.addError("please enter your name here");
      return false;
    }
    _nameController.sink.add("");

    if (phone == null || phone.length == 0) {
      _phoneController.sink.addError("please enter your phone number here");
      return false;
    }
    _phoneController.sink.add("");

    if (email == null || email.length == 0) {
      _emailController.sink.addError("please enter your email here");
      return false;
    }
    _emailController.sink.add("");

    if (pass == null || pass.length < 8) {
      _passController.sink.addError("please enter password which is at least 8 characters long");
      return false;
    }
